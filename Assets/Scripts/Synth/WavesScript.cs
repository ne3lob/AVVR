...
public class WavesScript : MonoBehaviour
{
    ...
    private OSCMessage messageOff;
    private OSCMessage messageSaw;
    ...
    public void SocketOFF(XRBaseInteractable interactable)
    {
        ...
        SocketType(out messageOff, oscAddressSynthWaveVCO, 0);
    }
    ...
    public void SocketSaw(XRBaseInteractable interactable)
    {
        ...
        SocketType(out messageSaw, oscAddressSynthWaveVCO, 1);
